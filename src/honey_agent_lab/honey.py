...
class HoneyAgent:
    """Defensive undercover observer for synthetic simulations.

    The Honey Agent does not recruit, exploit, or manipulate. It observes inbound
    synthetic messages, scores them, and asks the policy engine for containment.
    """

    def __init__(
        self,
        name: str = "honey-agent-01",
    ...
    def observe(self, message: Message) -> tuple[RiskAssessment, PolicyDecision]:
